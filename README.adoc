...
* https://www.sandimetz.com/products[Literatura] – książki Sandi Metz i jej prezentacja z YouTube:
...
. (...).
. https://github.com/davidhalter/jedi[Jedi] (static analysis library).
  
  https://github.com/python/mypy[Mypy] (Optional Static Typing).
